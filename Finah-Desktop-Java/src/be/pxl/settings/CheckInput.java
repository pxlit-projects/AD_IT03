...
public class CheckInput {
	...
	public boolean checkInput(JTextField firstNameTextField,
		...
		if (firstNameTextField.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Gelieve een voornaam in te vullen.");
		} else if (lastNameTextField.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Gelieve een achternaam in te vullen.");
		} else if (loginTextField.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Gelieve een login in te vullen.");
			...
			JOptionPane.showMessageDialog(null, "Gelieve een email in te vullen.");
		} else if (!m.matches()) {
			JOptionPane.showMessageDialog(null, "Dit is geen correct email adres");
		} else if (streetTextField.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Gelieve een straat in te vullen.");
		} else if (townTextField.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Gelieve een stad in te vullen.");
		} else if (zipCodeTextField.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Gelieve een postcode in te vullen.");
		} else if (!isInteger(zipCodeTextField.getText(), 10)) {
			JOptionPane.showMessageDialog(null, "Een postcode kan enkel cijfers bevatten.");
		} else {
			try {
				datePicker.getModel().getValue().equals(null);
			} catch (NullPointerException npe) {
				JOptionPane.showMessageDialog(null, "Gelieve een geboortedatum in te vullen.");
				return false;
			}
			return true;
		}
