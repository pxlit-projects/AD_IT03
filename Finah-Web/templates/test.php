...
$rowLabels = array( "Vraag1", "Vraag2", "Vraag3", "Vraag4" );
$chartXPos = 20;
$chartYPos = 250;
$chartWidth = 160;
$chartHeight = 80;
$chartXLabel = "FINAH";
$chartYLabel = "Antwoorden";
$chartYStep = 20000;
...
$pdf->Write( 19, "Bedankt voor het invullen van de vragenlijst." );
$pdf->Ln( 16 );
$pdf->SetFont( 'Arial', '', 12 );
$pdf->Write( 6, "Hieronder krijgt u een overzicht van de resultaten." );
//$pdf->Ln( 12 );
